...
Twitter, only one API exposes data in XML rather than JSON.[1](#fn:1) Twitter, to
...
information as early as 1996.[4](#fn:4) Since the message is just JavaScript, it
...
new ways.”[5](#fn:5) AJAX was the name that Garrett was giving to a new approach to
...
> string them up. Now.[7](#fn:7)

It’s easy to understand Winer’s frustration. XML has never been widely loved.
Even Winer has said that he does not love XML.[8](#fn:8) But XML was designed to be a
...
understand, since its syntax is minimal and its structure is predictable.[10](#fn:10)
Other bloggers have focused on XML’s verbosity and “the angle bracket
tax.”[11](#fn:11) Each opening tag in XML must be matched with a closing tag, meaning
...
JSON was designed as a data interchange format.[12](#fn:12) It was meant to carry
...
1. <http://www.cs.tufts.edu/comp/150IDS/final_papers/tstras01.1/FinalReport/FinalReport.html#software> [↩](#fnref:1)
2. <https://insights.stackoverflow.com/trends?tags=json%2Cxml%2Cprotocol-buffers%2Cyaml%2Ccsv> [↩](#fnref:2)
3. Zakas, Nicholas C., et al. “What Is Ajax?” Professional Ajax, 2nd ed., Wiley, 2007. [↩](#fnref:3)
4. <https://youtu.be/-C-JoyNuQJs?t=32s> [↩](#fnref:4)
5. <http://adaptivepath.org/ideas/ajax-new-approach-web-applications/> [↩](#fnref:5)
6. ibid. [↩](#fnref:6)
7. <http://scripting.com/2006/12/20.html> [↩](#fnref:7)
8. <http://blogoscoped.com/archive/2009-03-05-n15.html> [↩](#fnref:8)
9. <https://scripting.wordpress.com/2006/12/20/scripting-news-for-12202006/#comment-26383> [↩](#fnref:9)
10. <http://www.json.org/xml.html> [↩](#fnref:10)
11. <https://blog.codinghorror.com/xml-the-angle-bracket-tax> [↩](#fnref:11)
12. <https://youtu.be/-C-JoyNuQJs?t=33m50sgg> [↩](#fnref:12)