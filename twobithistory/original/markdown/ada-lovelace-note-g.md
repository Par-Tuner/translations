...
constitutes a “minor academic specialty.”[1](#fn:1) Inevitably, the fact that
...
that also permits a geometrical interpretation.[2](#fn:2)
...
power wasn’t published for another 500 years.[3](#fn:3)
...
taken him years and he did not state a general solution.[4](#fn:4) Blaise Pascal
finally outlined a general method in 1665, though it depended on first knowing
how to calculate the sum of integers raised to every lesser power.[5](#fn:5) To
...
integers to the first, second, and third powers.[6](#fn:6) These he gave in
...
small steps.[8](#fn:8) These small steps involved only addition and subtraction,
...
to demonstrate his ideas at parties.[9](#fn:9) But even after spending an amount of
public money equal to the cost of two large warships, he never built the entire
machine.[10](#fn:10) Babbage could not find anyone in the early 1800s that could make
...
she was 17 and he was 41.[11](#fn:11) Lovelace was fascinated with Babbage’s
...
discovered De Morgan’s laws, as her tutor.[12](#fn:12) Lovelace saw the potential of
...
numbers, each containing twenty figures, in *three minutes*”[14](#fn:14) (emphasis in
...
answer.[15](#fn:15) These were programs in the same sense that Lovelace’s own program
...
engine.”[16](#fn:16) She added that the machine might one day, for example, compose
...
scientists for more advanced thinking.[17](#fn:17) The miraculous foresight that
...
program.”[18](#fn:18) Maybe that’s the right way to think about Lovelace’
...
twenty programs that he never published.[19](#fn:19) So it’s not quite accurate to say
...
> consign the execution of them to a workman.[20](#fn:20)
...
1. Walter Isaacson, The Innovators (New York: Simon & Schuster Paperbacks, 2015), 25. [↩](#fnref:1)
2. Janet Beery, “Sums of Powers of Positive Integers: Archimedes,” Mathematical Association of America, accessed August 18, 2018, <https://www.maa.org/press/periodicals/convergence/sums-of-powers-of-positive-integers-archimedes-287-212-bce-greece-italy>. [↩](#fnref:2)
3. Janet Beery, “Sums of Powers of Positive Integers: Abu Ali Al-Hasan Ibn Al-Hasan Ibn Al-Haytham,” Mathematical Association of America, accessed August 18, 2018, <https://www.maa.org/press/periodicals/convergence/sums-of-powers-of-positive-integers-abu-ali-al-hasan-ibn-al-hasan-ibn-al-haytham-965-1039-egypt>. [↩](#fnref:3)
4. Janet Beery, “Sums of Powers of Positive Integers: Conclusion,” Mathematical Association of America, accessed August 18, 2018, <https://www.maa.org/press/periodicals/convergence/sums-of-powers-of-positive-integers-conclusion>. [↩](#fnref:4)
5. Janet Beery, “Sums of Powers of Positive Integers: Blaise Pascal,” Mathematical Association of America, accessed August 18, 2018, <https://www.maa.org/press/periodicals/convergence/sums-of-powers-of-positive-integers-blaise-pascal-1623-1662-france>. [↩](#fnref:5)
6. Janet Beery, “Sums of Powers of Positive Integers: Jakob Bernoulli,” Mathematical Association of America, accessed August 18, 2018, <https://www.maa.org/press/periodicals/convergence/sums-of-powers-of-positive-integers-jakob-bernoulli-1654-1705-switzerland>. [↩](#fnref:6)
7. Isaacson, 19. [↩](#fnref:7)
8. Isaacson, 20. [↩](#fnref:8)
9. Robert Scoble, “A Demo of Charles Babbage’s Difference Engine,” YouTube, June 17, 2010, accessed August 18, 2018, <https://www.youtube.com/watch?v=BlbQsKpq3Ak&feature=youtu.be&t=7m37s>. [↩](#fnref:9)
10. Isaacson, 22. [↩](#fnref:10)
11. Isaacson, 8. [↩](#fnref:11)
12. Isaacson, 17. [↩](#fnref:12)
13. Isaacson, 25. [↩](#fnref:13)
14. Luigi Menabrea, “Sketch of the Analytical Engine,” Scientific Memoirs 3 (1843): 686, accessed August 18, 2018, <https://books.google.com/books/about/Scientific_Memoirs_Selected_from_the_Tra.html?id=qsY-AAAAYAAJ>. [↩](#fnref:14)
15. Ada Lovelace, “Translator’s Notes to M. Menabrea’s Memoir,” Scientific Memoirs 3 (1843): 712, accessed August 18, 2018, <https://books.google.com/books/about/Scientific_Memoirs_Selected_from_the_Tra.html?id=qsY-AAAAYAAJ>. [↩](#fnref:15)
16. Lovelace, 694. [↩](#fnref:16)
17. Menabrea, 690. [↩](#fnref:17)
18. “Bernoulli number,” Wikipedia, accessed August 18, 2018, <https://en.wikipedia.org/wiki/Bernoulli_number>. [↩](#fnref:18)
19. Isaacson, 29. [↩](#fnref:19)
20. Menabrea, 689. [↩](#fnref:20)