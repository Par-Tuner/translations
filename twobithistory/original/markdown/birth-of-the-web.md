...
the world as a series of loose associations, the way human beings do.[2](#fn:2) In
...
of the web, had an institutional culture bordering on the anarchic.[3](#fn:3)
...
them.[4](#fn:4) In the evenings and during his time off, Berners-Lee worked on a
...
because it evoked a magical portal to a world full of information.[5](#fn:5)
...
manager on a floppy disk, but the disk was later lost.[6](#fn:6) (ENQUIRE’s
...
documents for the printer.[7](#fn:7) SGML, the markup language that Berners-Lee would
...
great potential.[8](#fn:8) That was when, as Berners-Lee writes, “the Internet came into
my life.”[9](#fn:9)
...
CERN.[10](#fn:10) But the closed nature of ENQUIRE was too limiting. Berners-Lee began
...
F. Codd, who [ten years earlier](/2017/12/29/codd-relational-model.html) demonstrated the many advantages of the relational database model over the
...
would [try to bring typing back](/2018/05/27/semantic-web.html) by
...
rewrite his original proposal in more concrete terms.[12](#fn:12) The [1990
...
framework, would make developing the “browser” program straightforward.[13](#fn:13)
...
Pellow to create what they called a “line-mode” browser.[14](#fn:14) The line-mode
...
1. Coover, Robert. “The End of Books.” The New York Times, June 21, 1992. Accessed June 2, 2018, <https://archive.nytimes.com/www.nytimes.com/books/98/09/27/specials/coover-end.html?pagewanted=all>. [↩](#fnref:1)
2. Berners-Lee, Tim, and Mark Fischetti. *Weaving the Web: The Original Design and Ultimate Destiny of the World Wide Web*. (Harper Business, 2000), 3. [↩](#fnref:2)
3. Berners-Lee, 9. [↩](#fnref:3)
4. ibid. [↩](#fnref:4)
5. Berners-Lee, 1. [↩](#fnref:5)
6. Berners-Lee, 11. [↩](#fnref:6)
7. Berners-Lee, 12. [↩](#fnref:7)
8. Berners-Lee, 19. [↩](#fnref:8)
9. ibid. [↩](#fnref:9)
10. Berners-Lee, 15. [↩](#fnref:10)
11. “Tim Berners-Lee’s Proposal”. CERN, accessed June 10, 2018, <http://info.cern.ch/Proposal.html>. [↩](#fnref:11)
12. Berners-Lee, 26. [↩](#fnref:12)
13. Berners-Lee, 23. [↩](#fnref:13)
14. Berners-Lee, 29. [↩](#fnref:14)